    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            <div class="col-md-12">
                ...
                <h3 class="tile-title text-white">Demo Predictions </h3>
                <div class="tile-body">
                                    ...
                                    foreach($predictions as $key => $prediction){
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-danger col-12 btn-sm delete_trade_signal">Delete this trade signal</button>
                                                </td>
                                            </tr> 
                                        <?php
                                    }
