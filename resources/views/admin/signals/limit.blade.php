                ...
                <div class="row">
                	<div class="col-md-4">
                		<div class="form-group">
                  			...
                  			<div class="input-group ">
                    			<input id="limitFrom" type="text" name="limit_range_from" class="form-control input-lg">
                    ...
                    <div class="col-md-4">
                		<div class="form-group">
                  			...
                  			<div class="input-group ">
                    			<input id="limitTo" type="text" name="stop_limit_range_from" class="form-control input-lg">
                    			<div class="input-group-append"><span class="input-group-text bg-default text-white">USDT</span></div>
                  			</div>
                		</div>
                	</div>
...
@section('javascript')
    ...
    <script>
        $('#generate_predictions').on('click', function(){
            ...
            $.ajax({
                url: "/admin/create/limit/trade/signals",
                headers: {
                ...
                success: function(response) {
                    ...
                    $('#amount_range_from, #amount_range_to, #limitFrom, #limitTo').val('');
