...
<head>
    ...
    <title>Coinshape Admin Panel | Login Page</title>
                        ...
                        <form class="text-left" method="post" action="{{ route('admin.login') }}">
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="username" name="email" type="text" class="form-control @error('email') is-invalid @enderror" placeholder="e.g admin@coinshape.com" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                    @error('email')
