...
$('#fromInputField').on('input', function () {
  var amount = $('#fromInputField').val();
  var fromCoin = $('#from_coin').val();
  var toCoin = $('#to_coin').val();
  $.each(wls, function () {
    if (this.wallet_type == fromCoin) {
      ...
      if (parseFloat(amount) > balance) {
        ...
        $.get('https://coinlib.io/api/v1/coin?key=d8f248bc24e63c89&pref=' + toCoin + '&symbol=' + fromCoin, function (response) {
          var total = parseFloat(response.price) * parseFloat($('#fromInputField').val());
          $('#loadingSpinner, #arrowSvg').toggleClass('d-none');
  ...
  $.each(wls, function () {
    if (this.wallet_type == fromCoin) {
      ...
      if (balance <= 0) {
        ...
        $('#loadingSpinner, #arrowSvg').toggleClass('d-none');
        $.get('https://coinlib.io/api/v1/coin?key=d8f248bc24e63c89&pref=' + toCoin + '&symbol=' + fromCoin, function (response) {
          var total = parseFloat(response.price) * parseFloat(balance);
          $('#loadingSpinner, #arrowSvg').toggleClass('d-none');
          $('#toInputField').val(total);
        });
      }
...
/***/ 2:
/*!*****************************************!*\
  !*** multi ./resources/js/swap/main.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp1\htdocs\coinshape\resources\js\swap\main.js */"./resources/js/swap/main.js");
